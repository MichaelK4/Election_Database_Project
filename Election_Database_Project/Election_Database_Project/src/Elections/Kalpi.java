...
public class Kalpi implements Serializable{
	...
	public Kalpi(KalpiType type, String kalpiLocation, int KalpiID) {
		this.type = type;
	...
	public String TypeStringForDB(KalpiType type)
	{
		String typeOfKalpi;
		if (type == KalpiType.NormalKalpi) {
			typeOfKalpi = "NormalKalpi";
			return typeOfKalpi;
		}
		if (type == KalpiType.CoronaKalpi) {
			typeOfKalpi = "CoronaKalpi";
			return typeOfKalpi;
		}
		if (type == KalpiType.ArmyKalpi) {
			typeOfKalpi = "ArmyKalpi";
			return typeOfKalpi;
		}
		if (type == KalpiType.ArmyCoronaKalpi) {
			typeOfKalpi = "ArmyCoronaKalpi";
			return typeOfKalpi;
		}
		return null;
	}
	...
	public String toString() {
		...
		sb.append("Number of votes: " + this.getNumOfVotes() + "\r\n");
		...
		//sb.append("Votes:" + getVotesInKalpi() + "\r\n");
